...
# Optionally, remove keyframes from materials or other data blocks
...
file_path = 'Volumes/Consulting/Salesforce Tower/data/normalized_sun_altitude_data_jun2023_to_jun2024.csv'
z_axis_scale = 0.83
energy_scale = 2.0
...
with open(file_path, mode='r') as file:
    ...
    for row in reader:
        ...
        if change:
            ...
            sun_obj.location[2] = z_value*z_axis_scale
            ...
            sun_energy = z_value * energy_scale  # Scale the sun energy if needed
            ...
            sky_energy = z_value  # Scale the sky energy if needed
